        ...
        {products.map((product, index) => (
          ...
          >
            <div className="relative aspect-square bg-gray-100 overflow-hidden">
              ...
              <button className="absolute bottom-4 right-4 p-3 bg-white rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity hover:bg-blue-600 hover:text-white">
